...
class DoctorExperienceInfoInsert extends StatefulWidget {
  var id;
  
  DoctorExperienceInfoInsert({Key? key,  required this.id}) : super(key: key);

  @override
  _DoctorExperienceInfoInsertState createState() =>
      _DoctorExperienceInfoInsertState();
}

class _DoctorExperienceInfoInsertState
    extends State<DoctorExperienceInfoInsert> {
  ...
  Future verifyUser() async {
    ...
    var apiUrl = "http://192.168.0.121:9010/api/experienceinsert/${widget.id}";
